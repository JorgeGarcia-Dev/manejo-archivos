...
def crear():
    """
    Iteramos sobre los archivos en la carpeta y
    luego creamos una nueva carpeta para cada
    extensión de archivo.
    """

    # Por medio de un ciclo for, iteramos sobre nuestra carpeta de archivos.
    for fichero in carpeta_archivos.iterdir():
        # Indicamos que agregue la extensión
        # de los archivos a la lista(carpetas)
    ...
    # Iterando sobre la carpeta principal (carpeta_archivos)
    # e imprimiendo los directorios.
    for fichero in carpeta_archivos.iterdir():
        if fichero.is_dir():
            print("·", fichero.name)
